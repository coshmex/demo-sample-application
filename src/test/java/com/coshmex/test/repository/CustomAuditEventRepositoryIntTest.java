package com.coshmex.test.repository;

import com.coshmex.test.DemoApplicationApp;
import com.coshmex.test.config.Constants;
import com.coshmex.test.config.audit.AuditEventConverter;
import com.coshmex.test.domain.PersistentAuditEvent;
...
import static com.coshmex.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
